...
import com.ufes.delivery.view.BuscaProdutoView;
import com.ufes.delivery.view.CadastroClienteView;
import com.ufes.delivery.view.CadastroProdutoView;
import com.ufes.delivery.view.GestaoUsuarioView;
import com.ufes.delivery.view.IPainelPrincipalView;
import com.ufes.delivery.view.MovimentacaoEstoqueView;
import com.ufes.delivery.view.PedidoView;
import com.ufes.delivery.view.VisualizacaoPedidoView;
...
public class PainelPrincipalPresenter implements RepositorioObserver {
    ...
    private void configurarPainel() {
        ...
        if (sessao != null) {
            ...
            boolean isAdmin = sessao.getUsuario().getPerfil() == PerfilUsuario.ADMINISTRADOR;
